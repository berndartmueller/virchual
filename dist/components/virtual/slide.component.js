...
export class SlideComponent {
    constructor(options, index, realIndex, slide) {
    ...
    isVisible() {
        ...
        const position = floor((this.track.direction.toPosition(this.index) + this.track.direction.offset(this.index) - this.track.position) *
     ...
     */
    updateClasses(active, forVisibility) {
