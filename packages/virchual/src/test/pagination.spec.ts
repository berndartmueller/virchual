...
describe('Pagination', () => {
  it('returns active bullet index (center: 1, total: 3)', () => {
    const tests = [
      { input: 0, result: 0 },
      { input: 1, result: 1 },
      { input: 2, result: 2 },
  ...
  it('returns active bullet index (center: 2, total: 5)', () => {
    const tests = [
      { input: 0, result: 0 },
      { input: 1, result: 1 },
      { input: 2, result: 2 },
  ...
  it('returns active bullet index (center: 2, total: 8)', () => {
    const tests = [
      { input: 0, result: 0 },
      { input: 1, result: 1 },
      { input: 2, result: 2 },
  ...
  it('returns active bullet index (center: 2, total: 10)', () => {
    const tests = [
      { input: 0, result: 0 },
      { input: 1, result: 1 },
      { input: 2, result: 2 },
